...
<body>
	<div class="tab-content" id="course_update">
		<!-- STEP 1 -->
	...
	<script src="/vuejs/course/courseUpdateStore.js"></script>
	<script src="/vuejs/course/courseUpdate.js"></script>
</body>
</html>