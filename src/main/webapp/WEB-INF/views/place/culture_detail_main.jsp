...
<body>
	...
	<div class="container" style="padding-top: 100px;" id="culture_detail">
		<div class="row">
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="margin-top: 40px;">
				<div class="mb40">
					<img :src="store.pvo.thumbnail" class="thumbnail" style="float: left; margin: 0px 20px 0px 0px; width: 270px; height: 350px;">
					...
					<ul style="list-style: none;">
						...
						<li><b>관람연령</b><span style="font-size: 14px; margin-left: 10px;">{{store.pvo.rating ? store.pvo.rating : '-'}}</span></li>
						<li><b>소요시간</b><span style="font-size: 14px; margin-left: 10px;">{{store.pvo.runtime ? store.pvo.runtime : '-'}}</span></li>
						<li><b>업체명</b><span style="font-size: 14px; margin-left: 10px;">{{store.pvo.company ? store.pvo.company : '-'}}</span></li>
						<li><b>연락처</b><span style="font-size: 14px; margin-left: 10px;">{{store.pvo.phone ? store.pvo.phone : '-'}}</span></li>
						<li><b>영업시간</b><span style="font-size: 14px; margin-left: 10px;">{{store.pvo.hours ? store.pvo.hours : '-'}}</span></li>
						<li><b>장소 등록일</b><span style="font-size: 14px; margin-left: 10px;">{{store.pvo.createday ? store.pvo.createday : '-'}}</span></li>
						<li>
							<p style="color: #800020; font-size: 14px; margin: 10px;">
		...
		<div class="text-right" style="margin-top: 5px;">
			<button class="btn btn-sm" style="background-color: black; color: white;" onclick="javascript:history.back()">목록</button>
		</div><hr>
		<div class="container">
